...
# Classes to evaluate
path = r"D:\Work\Data\SortedData\Action"
...
def sequence_generator(bs = 4, nFrames = 15, nSeqsPerPlayer = 90, shouldAugment = True, printLabel = False):
    width = 100
    height = 100
...
seq.fit_generator(sequence_generator(), steps_per_epoch = 150, epochs = 80, validation_data = sequence_generator(shouldAugment = False), validation_steps = 20)


# In[4]:


#seq.evaluate_generator(sequence_generator(), steps = 10)
seq.predict_generator(sequence_generator(shouldAugment = False, printLabel = True), 4)
