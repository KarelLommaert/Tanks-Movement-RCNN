...
# Classes to evaluate
path = r"D:\Work\Data\SortedData\Gameplay"
...
def sequence_generator(bs = 4, nFrames = 15, nSeqsPerPlayer = 80, shouldAugment = True, printLabel = False):
    width = 100
    height = 100
...
seq.fit_generator(sequence_generator(), steps_per_epoch = 200, epochs = 80, validation_data = sequence_generator(shouldAugment = False), validation_steps = 20)
